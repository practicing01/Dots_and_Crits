...
function Scale_Position_Vector_To_Camera_By_Resolution(%Vector_2D,%Vector_2D_Resolution)//assumes that x=0=left, y=0=top and +y=down, -y=up
{
...
%Vector_2D_Scaled.X=(%Vector_2D_Scaled.X*$Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D_Scaled.Y=(%Vector_2D_Scaled.Y*$Resolution.Y)/%Vector_2D_Resolution.Y;
...
function Scale_Vector_To_Camera_By_Resolution(%Vector_2D,%Vector_2D_Resolution)
{

%Vector_2D.X=(%Vector_2D.X*$Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D.Y=(%Vector_2D.Y*$Resolution.Y)/%Vector_2D_Resolution.Y;
