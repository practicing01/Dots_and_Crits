...
%Script_Object_Player_Sprite.Composite_Sprite.setSpriteSize(Scale_Ass_Size_Vector_To_Camera(%this.Ass_Image_Gill_Balentine_Stand_Down));
%Script_Object_Player_Sprite.Composite_Sprite.setSpriteImage("Module_Player_Sprite_Gill_Balentine:Image_Gill_Balentine_Stand_Down",0);
