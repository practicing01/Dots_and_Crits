...
Module_Player_Sprite_Ayn.Gui_Button_Gui_Menu_Config(%this.Sprite_Player_Parent);

}
else if (%this.String_Action$="Emote")
{

Module_Player_Sprite_Ayn.Gui_Button_Gui_Menu_Emote(%this.Sprite_Player_Parent);
