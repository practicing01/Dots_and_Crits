...
%Script_Object_Player_Sprite.Sprite.setSize(Scale_Ass_Size_Vector_To_Camera(%this.Ass_Image_Ayn));
%Script_Object_Player_Sprite.Sprite.setImage("Module_Player_Sprite_Ayn:Image_Ayn",0);

/************************************************************************/

%Script_Object_Player_Sprite.Sprite.clearCollisionShapes();

%Collision_Shape_Index=%Script_Object_Player_Sprite.Sprite.createPolygonBoxCollisionShape(Scale_Ass_Size_Vector_To_Camera(%this.Ass_Image_Ayn));
