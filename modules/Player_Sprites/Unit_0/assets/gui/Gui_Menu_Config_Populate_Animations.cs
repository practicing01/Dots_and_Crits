function Module_Player_Sprite_Unit_0::Gui_Menu_Config_Populate_Animations(%this)
{

%this.Gui_Menu_Config.Gui_Scroller_Unit_0_Menu_Config_Objects.Gui_List_Unit_0_Menu_Config_Objects.clearItems();

if (%this.Gui_Menu_Config.Gui_Scroller_Unit_0_Menu_Config_Simsets.Gui_List_Unit_0_Menu_Config_Simsets.getSelectedItem()==-1){return;}

%this.Gui_List_Menu_Config_Selection_Simset=%this.Gui_Menu_Config.Gui_Scroller_Unit_0_Menu_Config_Simsets.Gui_List_Unit_0_Menu_Config_Simsets.getSelectedItem();

%Script_Object_Player_Sprite=%this.Gui_Menu_Config.Composite_Sprite_Player_Parent.Script_Object_Parent;

%String_Selected_Simset=%this.Gui_Menu_Config.Gui_Scroller_Unit_0_Menu_Config_Simsets.Gui_List_Unit_0_Menu_Config_Simsets.getItemText
(
%this.Gui_Menu_Config.Gui_Scroller_Unit_0_Menu_Config_Simsets.Gui_List_Unit_0_Menu_Config_Simsets.getSelectedItem()
);
...
%this.Gui_Menu_Config.Gui_Scroller_Unit_0_Menu_Config_Objects.Gui_List_Unit_0_Menu_Config_Objects.addItem(%Object.String_Animation_Name);
