...
Module_Player_Sprite_Unit_0.Gui_Button_Gui_Menu_Config(%this.Composite_Sprite_Player_Parent);

}
else if (%this.String_Action$="Emote")
{

Module_Player_Sprite_Unit_0.Gui_Button_Gui_Menu_Emote(%this.Composite_Sprite_Player_Parent);
