function Module_Map_Bath_Salts::Schedule_Camera_Move(%this,%Direction)
{
...
%this.Camera_Move_Schedule.Schedule_Handle=schedule(25,0,"Module_Map_Bath_Salts::Move_Camera",%this);
