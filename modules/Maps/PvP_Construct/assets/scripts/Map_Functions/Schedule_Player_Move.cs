function Module_Map_PvP_Construct::Schedule_Player_Move(%this,%Direction)
{
...
%this.Player_Move_Schedule.Schedule_Handle=schedule(0,0,"Module_Map_PvP_Construct::Move_Player",%this);
