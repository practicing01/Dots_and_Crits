function Module_Map_Kana_Study::Schedule_Player_Move(%this,%Direction)
{
...
%this.Player_Move_Schedule.Schedule_Handle=schedule(0,0,"Module_Map_Kana_Study::Move_Player",%this);
