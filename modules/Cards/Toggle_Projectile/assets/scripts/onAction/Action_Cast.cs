function Module_Card_Toggle_Projectile::Action_Cast(%this,%Player_Information,%Player_Sprite_Target_Game_Connection_Handle)
{
...
if (%Player_Object==0)//New Toggle_Projectile user.
{
...
if (%Player_Object.Bool_Toggle_Projectile)
{

%Player_Object.Bool_Toggle_Projectile=false;

}
else
{

%Player_Object.Bool_Toggle_Projectile=true;
