function Module_Card_Toggle_Projectile::Initialize_Variables(%this)
{
...
Position="0 0";
size="1 1";
class="Scene_Object_Module_Card_Toggle_Projectile_Input_Capture";
...
%this.Toggle_Projectile_Count=0;
