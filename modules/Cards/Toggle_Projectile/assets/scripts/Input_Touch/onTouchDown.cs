function Scene_Object_Module_Card_Toggle_Projectile_Input_Capture::onTouchDown(%this,%Touch_ID,%World_Position,%Mouse_Clicks)
{
/**************************************************/
...
commandToServer('Relay_Module_Function',Module_Card_Toggle_Projectile,"Action_Animate_Cast",
...
if (%this.Module_ID_Parent.Player_Information_This.Bool_Toggle_Projectile)
{

%this.Module_ID_Parent.Toggle_Projectile_Count++;

commandToServer('Relay_Module_Function',Module_Card_Toggle_Projectile,"Action_Shoot",
%this.Module_ID_Parent.Player_Information_This.Player_Information.Game_Connection_Handle,%World_Position,%this.Module_ID_Parent.Toggle_Projectile_Count);
