function Scene_Object_Module_Card_Bomb_Input_Capture::onTouchDown(%this,%Touch_ID,%World_Position,%Mouse_Clicks)
{
/**************************************************/
...
commandToServer('Relay_Module_Function',Module_Card_Bomb,"Action_Animate_Cast",
