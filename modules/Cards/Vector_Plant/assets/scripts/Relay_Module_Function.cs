function Module_Card_Vector_Plant::Relay_Module_Function(%this,%Client,%Module_Function,
...
else if (%Module_Function$="Action_Grow")
{

%this.Action_Grow(%Player_Information,%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4,%Parameter_5);
