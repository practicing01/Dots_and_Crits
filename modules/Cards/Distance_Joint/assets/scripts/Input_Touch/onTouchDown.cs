function Scene_Object_Module_Card_Distance_Joint_Input_Capture::onTouchDown(%this,%Touch_ID,%World_Position,%Mouse_Clicks)
{
/**************************************************/
...
%this.Module_ID_Parent.Card_Target_0=0;
...
%this.Module_ID_Parent.Card_Target_0=%Object;

break;

}

if (%this.Module_ID_Parent.Card_Target_0==0){return;}

%this.Module_ID_Parent.Card_Cast(%this.Module_ID_Parent.Card_Target,%this.Module_ID_Parent.Card_Target_0);
