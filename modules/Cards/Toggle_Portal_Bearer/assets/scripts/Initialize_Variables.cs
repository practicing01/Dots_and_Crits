function Module_Card_Toggle_Portal_Bearer::Initialize_Variables(%this)
{
...
Position="0 0";
size="1 1";
class="Scene_Object_Module_Card_Toggle_Portal_Bearer_Input_Capture";
...
%this.Toggle_Portal_Bearer_Count=0;
