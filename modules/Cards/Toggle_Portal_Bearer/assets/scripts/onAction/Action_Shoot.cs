function Module_Card_Toggle_Portal_Bearer::Action_Shoot(%this,%Player_Information,%Player_Sprite_Target_Game_Connection_Handle,%Vector_2D_Position,%Object_Index)
{
...
Size=Scale_Ass_Size_Vector_To_Camera(%this.Ass_Image_Toggle_Portal_Bearer_Projectile);
Image="Module_Card_Toggle_Portal_Bearer:Image_Toggle_Portal_Bearer_Projectile";
class="Class_Toggle_Portal_Bearer_Projectile";
...
%Projectile.Angle=Vector2AngleToPoint(%Target_Player.Player_Sprite_Data.Sprite.Position,%Vector_2D_Position)-90;
...
%Projectile.setBlendColor(getRandomF(0,1),getRandomF(0,1),getRandomF(0,1));

}
else
{

%Projectile.setBlendColor(%Previous_Portal.getBlendColor());
...
%Projectile.moveTo(%Vector_2D_Position,100,true,false);
