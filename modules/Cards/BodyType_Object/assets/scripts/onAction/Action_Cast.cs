function Module_Card_BodyType_Object::Action_Cast(%this,%Player_Information,
%Bool_Type_Of_Object,
...
if (%Scene_Object.BodyType$="static")
{

%Scene_Object.BodyType="dynamic";

}
else if (%Scene_Object.BodyType$="dynamic")
{

%Scene_Object.BodyType="static";
