function Module_Card_Volley_Projectile::Initialize_Variables(%this)
{
...
Position="0 0";
size="1 1";
class="Scene_Object_Module_Card_Volley_Projectile_Input_Capture";
...
%this.Volley_Projectile_Count=0;

%this.Vector_2D_Table=0;
