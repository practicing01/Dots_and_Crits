function Module_Card_Volley_Projectile::Action_Cast(%this,%Player_Information,%Player_Sprite_Target_Game_Connection_Handle,%Vector_2D_Position,%Object_Index)
{
...
%Sprite_Volley_Projectile=new Sprite()
{

Position=%Vector_2D_Position;
Size=Scale_Ass_Size_Vector_To_Camera(%this.Ass_Image_Volley_Projectile);
Image="Module_Card_Volley_Projectile:Image_Volley_Projectile";
Animation="Module_Card_Volley_Projectile:Animation_Volley_Projectile";
class="Class_Volley_Projectile";
...
%Collision_Shape_Index=%Sprite_Volley_Projectile.createCircleCollisionShape(%Radius);

%Sprite_Volley_Projectile.setCollisionShapeIsSensor(%Collision_Shape_Index,true);
...
Scene_Dots_and_Crits.add(%Sprite_Volley_Projectile);

%Sprite_Volley_Projectile.mount(%Target_Player.Player_Sprite_Data.Scene_Object_Mount,%Vector_2D_Mount_Offset,0,true,mDegToRad(0));

%Sprite_Volley_Projectile.dismount();

%Sprite_Volley_Projectile.Position=%Sprite_Volley_Projectile.Position;

%this.Simset_Objects.add(%Sprite_Volley_Projectile);
...
%Simset_Vector_2D_Volley_Nodes=%this.Vector_2D_Table.getObject(%New_Angle);

for (%y=0;%y<%Simset_Vector_2D_Volley_Nodes.getCount();%y++)
{

%Vector_2D_Node=%Simset_Vector_2D_Volley_Nodes.getObject(%y);

%Vector_2D_Destination.X=%Vector_2D_Node.X;
%Vector_2D_Destination.Y=%Vector_2D_Node.Y;

%Vector_2D_Destination.X+=%Sprite_Volley_Projectile.Position.X;
%Vector_2D_Destination.Y+=%Sprite_Volley_Projectile.Position.Y;
...
%Sprite_Volley_Projectile.Simset_Vector_2D_Wave_Nodes=%Simset_Vector_2D_Wave_Nodes;

%Vector_2D_Vector=%Sprite_Volley_Projectile.Simset_Vector_2D_Wave_Nodes.getObject(0);

%Vector_2D_Destination.X=%Vector_2D_Vector.X;
%Vector_2D_Destination.Y=%Vector_2D_Vector.Y;

%Sprite_Volley_Projectile.Simset_Vector_2D_Wave_Nodes.remove(%Vector_2D_Vector);

%Vector_2D_Vector.delete();

%Sprite_Volley_Projectile.moveTo(%Vector_2D_Destination,20,false,false);
