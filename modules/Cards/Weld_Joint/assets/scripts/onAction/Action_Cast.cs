function Module_Card_Weld_Joint::Action_Cast(%this,%Player_Information,
%Bool_Type_Of_Object,
...
Scene_Dots_and_Crits.createWeldJoint(%Target_Player.Player_Sprite_Data.Composite_Sprite,%Target_Player_0.Player_Sprite_Data.Composite_Sprite,
%Target_Player.Player_Sprite_Data.Composite_Sprite.getLocalVector(%Target_Player_0.Player_Sprite_Data.Composite_Sprite.Position),%Target_Player_0.Player_Sprite_Data.Composite_Sprite.getLocalVector(%Target_Player.Player_Sprite_Data.Composite_Sprite.Position),0.5,0.5,false);

}
else//%Scene_Object_0
{

Scene_Dots_and_Crits.createWeldJoint(%Target_Player.Player_Sprite_Data.Composite_Sprite,%Scene_Object_0,
%Target_Player.Player_Sprite_Data.Composite_Sprite.getLocalVector(%Scene_Object_0.Position),%Scene_Object_0.getLocalVector(%Target_Player.Player_Sprite_Data.Composite_Sprite.Position),0.5,0.5,false);
...
Scene_Dots_and_Crits.createWeldJoint(%Scene_Object,%Target_Player_0.Player_Sprite_Data.Composite_Sprite,
%Scene_Object.getLocalVector(%Target_Player_0.Player_Sprite_Data.Composite_Sprite.Position),%Target_Player_0.Player_Sprite_Data.Composite_Sprite.getLocalVector(%Scene_Object.Position),0.5,0.5,false);

}
else//%Scene_Object_0
{

Scene_Dots_and_Crits.createWeldJoint(%Scene_Object,%Scene_Object_0,
%Scene_Object.getLocalVector(%Scene_Object_0.Position),%Scene_Object_0.getLocalVector(%Scene_Object.Position),0.5,0.5,false);
