function Module_Card_Summon_Unit::Relay_Module_Function(%this,%Client,%Module_Function,
...
%this.Action_Attack(%Player_Information,%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3);
