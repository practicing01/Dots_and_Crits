function Module_Card_Summon_Unit::Action_Update_Health(%this,%Player_Information,%Unit_Game_Connection_Handle,%Unit_Object_Index,%Operation,%Amount)
{
...
%this.Simset_Objects.remove(%Unit);
