function Module_Card_Sine_Projectile::Initialize_Variables(%this)
{
...
Position="0 0";
size="1 1";
class="Scene_Object_Module_Card_Sine_Projectile_Input_Capture";
