function Scene_Object_Module_Card_Scale_Input_Capture::onTouchDown(%this,%Touch_ID,%World_Position,%Mouse_Clicks)
{
/**************************************************/
...
commandToServer('Relay_Module_Function',Module_Card_Scale,"Action_Animate_Cast",
