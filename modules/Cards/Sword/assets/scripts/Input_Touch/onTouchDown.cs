function Scene_Object_Module_Card_Sword_Input_Capture::onTouchDown(%this,%Touch_ID,%World_Position,%Mouse_Clicks)
{
/**************************************************/
...
commandToServer('Relay_Module_Function',Module_Card_Sword,"Action_Animate_Cast",
...
if (%this.Module_ID_Parent.Player_Information_This.Sprite_Sword.Visible)
{

commandToServer('Relay_Module_Function',Module_Card_Sword,"Action_Move",
