function Module_Card_Toggle_Wall_Tile::Action_Cast(%this,%Player_Information,%Player_Sprite_Target_Game_Connection_Handle)
{
...
if (%Player_Object==0)//New Toggle_Wall_Tile user.
{
...
if (%Player_Object.Bool_Toggle_Wall_Tile)
{

%Player_Object.Bool_Toggle_Wall_Tile=false;

}
else
{

%Player_Object.Bool_Toggle_Wall_Tile=true;
