function Scene_Object_Module_Card_Toggle_Wall_Tile_Input_Capture::onTouchDown(%this,%Touch_ID,%World_Position,%Mouse_Clicks)
{
/**************************************************/
...
commandToServer('Relay_Module_Function',Module_Card_Toggle_Wall_Tile,"Action_Animate_Cast",
...
if (%this.Module_ID_Parent.Player_Information_This.Bool_Toggle_Wall_Tile)
{

%this.Module_ID_Parent.Toggle_Wall_Tile_Count++;

commandToServer('Relay_Module_Function',Module_Card_Toggle_Wall_Tile,"Action_Shoot",
%this.Module_ID_Parent.Player_Information_This.Player_Information.Game_Connection_Handle,%World_Position,%this.Module_ID_Parent.Toggle_Wall_Tile_Count);
