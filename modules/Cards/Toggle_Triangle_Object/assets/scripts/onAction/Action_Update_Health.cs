function Module_Card_Toggle_Triangle_Object::Action_Update_Health(%this,%Player_Information,%Unit_Game_Connection_Handle,%Unit_Object_Index,%Operation,%Amount)
{
