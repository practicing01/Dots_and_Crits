function Module_Card_Toggle_Triangle_Object::Initialize_Variables(%this)
{
...
Position="0 0";
size="1 1";
class="Scene_Object_Module_Card_Toggle_Triangle_Object_Input_Capture";
...
%this.Toggle_Triangle_Object_Count=0;
