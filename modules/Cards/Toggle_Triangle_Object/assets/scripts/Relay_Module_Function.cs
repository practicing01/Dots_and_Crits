function Module_Card_Toggle_Triangle_Object::Relay_Module_Function(%this,%Client,%Module_Function,
...
else if (%Module_Function$="Action_Shoot")
{

%this.Action_Shoot(%Player_Information,%Parameter_0,%Parameter_1,%Parameter_2);
