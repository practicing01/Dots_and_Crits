function Module_Card_Collision_Supress_Object::Relay_Module_Function(%this,%Client,%Module_Function,
...
%this.Action_Cast(%Player_Information,%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3,%Parameter_4);
