function Module_Card_Portal_Bearer::Initialize_Variables(%this)
{
...
%this.Vector_2D_World_Position="0 0";
...
Position="0 0";
size="1 1";
class="Scene_Object_Module_Card_Portal_Bearer_Input_Capture";
