function Scene_Object_Module_Card_Portal_Bearer_Input_Capture::onTouchDown(%this,%Touch_ID,%World_Position,%Mouse_Clicks)
{
/**************************************************/
...
%this.Module_ID_Parent.Vector_2D_World_Position=%World_Position;

%this.Module_ID_Parent.Bool_Waiting_For_Cast=true;

//commandToServer('Relay_Module_Function',Module_Card_Portal_Bearer,"Action_Animate_Cast",
...
if (%this.Module_ID_Parent.Card_Target!=0)
{

%this.Module_ID_Parent.Card_Cast(%this.Module_ID_Parent.Card_Target.Script_Object_Parent,%this.Module_ID_Parent.Vector_2D_World_Position);

}
else
{

%this.Module_ID_Parent.Card_Cast(0,%this.Module_ID_Parent.Vector_2D_World_Position);
