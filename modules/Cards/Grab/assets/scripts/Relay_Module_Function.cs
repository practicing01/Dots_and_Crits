function Module_Card_Grab::Relay_Module_Function(%this,%Client,%Module_Function,
...
%this.Action_Cast(%Player_Information,%Parameter_0,%Parameter_1,%Parameter_2,%Parameter_3);
